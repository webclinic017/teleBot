...
class Candle():
    def __init__(self, df1):
        ...
        self.PatternRedEqShadows = ((((self.highShadowRed - self.bottomShadowRed) > 0) & ((self.highShadowRed - self.bottomShadowRed) <= (self.size * 0.1))) | (((self.bottomShadowRed - self.highShadowRed) > 0) & ((self.bottomShadowRed - self.highShadowRed) <= (self.size * 0.1))) | (self.bottomShadowRed == self.highShadowRed)) & ((self.bodyRed > 0.45) & (self.bodyRed < 0.55))
        self.PatternGreenEqShadows = ((((self.highShadowGreen - self.bottomShadowGreen) > 0) & ((self.highShadowGreen - self.bottomShadowGreen) <= (self.size * 0.1))) | (((self.bottomShadowGreen - self.highShadowGreen) > 0) & ((self.bottomShadowGreen - self.highShadowGreen) <= (self.size * 0.1))) | (self.bottomShadowGreen == self.highShadowGreen)) & ((self.bodyGreen > 0.45) & (self.bodyGreen < 0.55))
        self.PatternGreenDoje = (self.Green > 0) & (self.bodyGreen <= 0.15) & ((self.highShadowGreen / self.size) > 0.1) & ((self.PatternGreenBottomShadow / self.size) > 0.1)
        self.PatternRedDoje = (self.Red > 0) & (self.bodyRed <= 0.15) & ((self.PatternRedHighShadow / self.size) > 0.1) & ((self.PatternRedBottomShadow / self.size) > 0.1)